    ...
    public function rules(): array
{
    ...
    public function messages(): array
    {
        return [
            ...
            // MENSAJES PARA EL CAMPO 'inner'
            'inner.required' => 'La unidad de empaque (inner) es obligatoria.',
            'inner.integer' => 'La unidad de empaque (inner) debe ser un número entero.',
            'inner.min' => 'La unidad de empaque (inner) no puede ser menor a 1.',
        ];
    }
}